...
# Generated on: 2025-09-23T21:04:23.611
# Do not edit this file directly.

# pre_boil_size depends on struct VolumeType from measureable_units.json
# boil_time depends on struct TimeType from measureable_units.json
"""
...
# specific_gravity depends on struct GravityType from measureable_units.json
# pH depends on struct AcidityType from measureable_units.json
# time depends on struct TimeType from measureable_units.json
# duration depends on struct TimeType from measureable_units.json
"""
    struct TimingType
...
# conversion depends on struct PercentType from measureable_units.json
# mash depends on struct PercentType from measureable_units.json
# brewhouse depends on struct PercentType from measureable_units.json
# lauter depends on struct PercentType from measureable_units.json
"""
...
# original_gravity depends on struct GravityType from measureable_units.json
# apparent_attenuation depends on struct PercentType from measureable_units.json
# beer_pH depends on struct AcidityType from measureable_units.json
# style depends on struct RecipeStyleType from style.json
# color_estimate depends on struct ColorType from measureable_units.json
# ibu_estimate depends on struct IBUEstimateType from hop.json
# created depends on struct DateType from measureable_units.json
# final_gravity depends on struct GravityType from measureable_units.json
# boil depends on struct BoilProcedureType from boil.json
# packaging depends on struct PackagingProcedureType from packaging.json
# mash depends on struct MashProcedureType from mash.json
# alcohol_by_volume depends on struct PercentType from measureable_units.json
# batch_size depends on struct VolumeType from measureable_units.json
# fermentation depends on struct FermentationProcedureType from fermentation.json
"""
    struct RecipeType
...
# color depends on struct ColorType from measureable_units.json
"""
...
# coarse_grind depends on struct PercentType from measureable_units.json
# fine_grind depends on struct PercentType from measureable_units.json
# potential depends on struct GravityType from measureable_units.json
# fine_coarse_difference depends on struct PercentType from measureable_units.json
"""
    struct YieldType
...
# slant depends on struct VolumeType from measureable_units.json
# dry depends on struct MassType from measureable_units.json
# liquid depends on struct VolumeType from measureable_units.json
# culture depends on struct VolumeType from measureable_units.json
...
# potassium depends on struct ConcentrationType from measureable_units.json
# flouride depends on struct ConcentrationType from measureable_units.json
# chloride depends on struct ConcentrationType from measureable_units.json
# carbonate depends on struct ConcentrationType from measureable_units.json
# calcium depends on struct ConcentrationType from measureable_units.json
# sulfate depends on struct ConcentrationType from measureable_units.json
# nitrite depends on struct ConcentrationType from measureable_units.json
# nitrate depends on struct ConcentrationType from measureable_units.json
# iron depends on struct ConcentrationType from measureable_units.json
# sodium depends on struct ConcentrationType from measureable_units.json
# magnesium depends on struct ConcentrationType from measureable_units.json
# bicarbonate depends on struct ConcentrationType from measureable_units.json
"""
    struct WaterBase
...
# grain_temperature depends on struct TemperatureType from measureable_units.json
"""
...
# pinene depends on struct PercentType from measureable_units.json
# caryophyllene depends on struct PercentType from measureable_units.json
# xanthohumol depends on struct PercentType from measureable_units.json
# b_pinene depends on struct PercentType from measureable_units.json
# limonene depends on struct PercentType from measureable_units.json
# cohumulone depends on struct PercentType from measureable_units.json
# nerol depends on struct PercentType from measureable_units.json
# polyphenols depends on struct PercentType from measureable_units.json
# humulene depends on struct PercentType from measureable_units.json
# farnesene depends on struct PercentType from measureable_units.json
# linalool depends on struct PercentType from measureable_units.json
# geraniol depends on struct PercentType from measureable_units.json
# myrcene depends on struct PercentType from measureable_units.json
"""
...
# beta_acid depends on struct PercentType from measureable_units.json
# alpha_acid depends on struct PercentType from measureable_units.json
"""
...
# maximum_volume depends on struct VolumeType from measureable_units.json
"""
...
# packaged_volume depends on struct VolumeType from measureable_units.json
"""
...
"""
# timing_object depends on struct TimingType from timing.json
# version depends on struct VersionType from measureable_units.json
"""
    struct Beerjson
